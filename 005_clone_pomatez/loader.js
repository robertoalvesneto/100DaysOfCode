...
function renderProgress() {
  ...
  if (progress < 25) {
    ...
    document.querySelector(".animate-0-25-b").style.transform =
      "rotate(" + angle + "deg)";
  } else if (progress >= 25 && progress < 50) {
    var angle = -90 + ((progress - 25) / 100) * 360;
    document.querySelector(".animate-0-25-b").style.transform = "rotate(0deg)";
    document.querySelector(".animate-25-50-b").style.transform =
      "rotate(" + angle + "deg)";
  } else if (progress >= 50 && progress < 75) {
    var angle = -90 + ((progress - 50) / 100) * 360;
    document.querySelector(".animate-25-50-b").style.transform = "rotate(0deg)";
    document.querySelector(".animate-0-25-b").style.transform = "rotate(0deg)";
    document.querySelector(".animate-50-75-b").style.transform =
      "rotate(" + angle + "deg)";
    ...
    document.querySelector(".animate-25-50-b").style.transform = "rotate(0deg)";
    document.querySelector(".animate-0-25-b").style.transform = "rotate(0deg)";
    document.querySelector(".animate-75-100-b").style.transform =
      "rotate(" + angle + "deg)";
  }
}
...
function clearPomo() {
  ...
  let stringTime = stringTimer(
    isLongBreaking ? longBreakSeconds : isWorking ? workSeconds : breakSeconds,
    curentSeconds
  );
...
function updatePomo() {
  ...
  let isLongBreakFinished = isLongBreaking && curentSeconds == longBreakSeconds;
  let isWorkFinished =
...
function buttonSound() {
  ...
  document.querySelector(
    ".footer .volume .material-icons"
  ).innerHTML = soundEnabled ? "volume_up" : "volume_off";
}
